...
<div>
  ...
  <div>
    ...
    🔍 также активно погружаюсь в ML/DS<br><br>
    Мой путь в DA/ML/DL: 
    ...
    Мои
    <a href="https://github.com/Vedomant/data_analytics_cookbook"><img src="https://img.shields.io/badge/-конспекты-yellow?style=flat&logo=googlekeep&logoColor=white" alt="Мои конспекты"></a><br><br>
...
| -------------------- | :--------------------- |:---------------------------|:---------------------------|
| [Сourier_navigator](https://github.com/Vedomant/courier_route/tree/main?tab=readme-ov-file)| Поиск и оптимизация маршрута на карте с препятствиями | Реализован BFS (Breadth-First Search) для поиска кратчайшего пути, жадный алгоритм, работа с графами на сетке (grid-based pathfinding), проверка проходимости и валидации координат. Bonus: генерация карты с городской застройкой| ноябрь 2025 |
