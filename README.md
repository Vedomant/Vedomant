...
| -------------------- | :--------------------- |:---------------------------|:---------------------------|
| [Сourier_navigator](https://github.com/Vedomant/courier_route/tree/main?tab=readme-ov-file)| Оптимизация маршрута на карте с препятствиями: реализация BFS (Breadth-First Search) для поиска кратчайшего пути, жадного алгоритма, работа с графами на сетке (grid-based pathfinding), проверка проходимости и валидации координат, генерация карты с городской застройкой| ноябрь 2025 |
